...
type CreditmemosAPI interface {

	/*
		GetV1Creditmemos creditmemos
		...
		@return ApiGetV1CreditmemosRequest
	*/
	GetV1Creditmemos(ctx context.Context) ApiGetV1CreditmemosRequest

	// GetV1CreditmemosExecute executes the request
	//  @return SalesDataCreditmemoSearchResultInterface
	GetV1CreditmemosExecute(r ApiGetV1CreditmemosRequest) (*SalesDataCreditmemoSearchResultInterface, *http.Response, error)
}

// CreditmemosAPIService CreditmemosAPI service
type CreditmemosAPIService service

type ApiGetV1CreditmemosRequest struct {
	ctx                                              context.Context
	ApiService                                       CreditmemosAPI
...
// Field
func (r ApiGetV1CreditmemosRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1CreditmemosRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1CreditmemosRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1CreditmemosRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1CreditmemosRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1CreditmemosRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1CreditmemosRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1CreditmemosRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1CreditmemosRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1CreditmemosRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1CreditmemosRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1CreditmemosRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1CreditmemosRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1CreditmemosRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1CreditmemosRequest) Execute() (*SalesDataCreditmemoSearchResultInterface, *http.Response, error) {
	return r.ApiService.GetV1CreditmemosExecute(r)
}
...
Lists credit memos that match specified search criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included. See https://developer.adobe.com/commerce/webapi/rest/attributes#CreditmemoRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
	...
	@return ApiGetV1CreditmemosRequest
*/
func (a *CreditmemosAPIService) GetV1Creditmemos(ctx context.Context) ApiGetV1CreditmemosRequest {
	return ApiGetV1CreditmemosRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SalesDataCreditmemoSearchResultInterface
func (a *CreditmemosAPIService) GetV1CreditmemosExecute(r ApiGetV1CreditmemosRequest) (*SalesDataCreditmemoSearchResultInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SalesDataCreditmemoSearchResultInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CreditmemosAPIService.GetV1Creditmemos")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/V1/creditmemos"
