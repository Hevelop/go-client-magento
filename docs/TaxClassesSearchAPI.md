...
------------- | ------------- | -------------
[**GetV1TaxClassesSearch**](TaxClassesSearchAPI.md#GetV1TaxClassesSearch) | **Get** /V1/taxClasses/search | taxClasses/search



## GetV1TaxClassesSearch

> TaxDataTaxClassSearchResultsInterface GetV1TaxClassesSearch(ctx).SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field).SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value).SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType).SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field).SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction).SearchCriteriaPageSize(searchCriteriaPageSize).SearchCriteriaCurrentPage(searchCriteriaCurrentPage).Execute()
...
func main() {
	...
	resp, r, err := apiClient.TaxClassesSearchAPI.GetV1TaxClassesSearch(context.Background()).SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field).SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value).SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType).SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field).SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction).SearchCriteriaPageSize(searchCriteriaPageSize).SearchCriteriaCurrentPage(searchCriteriaCurrentPage).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TaxClassesSearchAPI.GetV1TaxClassesSearch``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetV1TaxClassesSearch`: TaxDataTaxClassSearchResultsInterface
	fmt.Fprintf(os.Stdout, "Response from `TaxClassesSearchAPI.GetV1TaxClassesSearch`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetV1TaxClassesSearchRequest struct via the builder pattern
