...
------------- | ------------- | -------------
[**GetV1CouponsSearch**](CouponsSearchAPI.md#GetV1CouponsSearch) | **Get** /V1/coupons/search | coupons/search



## GetV1CouponsSearch

> SalesRuleDataCouponSearchResultInterface GetV1CouponsSearch(ctx).SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field).SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value).SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType).SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field).SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction).SearchCriteriaPageSize(searchCriteriaPageSize).SearchCriteriaCurrentPage(searchCriteriaCurrentPage).Execute()
...
func main() {
	...
	resp, r, err := apiClient.CouponsSearchAPI.GetV1CouponsSearch(context.Background()).SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field).SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value).SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType).SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field).SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction).SearchCriteriaPageSize(searchCriteriaPageSize).SearchCriteriaCurrentPage(searchCriteriaCurrentPage).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CouponsSearchAPI.GetV1CouponsSearch``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetV1CouponsSearch`: SalesRuleDataCouponSearchResultInterface
	fmt.Fprintf(os.Stdout, "Response from `CouponsSearchAPI.GetV1CouponsSearch`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetV1CouponsSearchRequest struct via the builder pattern
