...
------------- | ------------- | -------------
[**GetV1ProductsAttributesetsGroupsList**](ProductsAttributeSetsGroupsListAPI.md#GetV1ProductsAttributesetsGroupsList) | **Get** /V1/products/attribute-sets/groups/list | products/attribute-sets/groups/list



## GetV1ProductsAttributesetsGroupsList

> EavDataAttributeGroupSearchResultsInterface GetV1ProductsAttributesetsGroupsList(ctx).SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field).SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value).SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType).SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field).SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction).SearchCriteriaPageSize(searchCriteriaPageSize).SearchCriteriaCurrentPage(searchCriteriaCurrentPage).Execute()
...
func main() {
	...
	resp, r, err := apiClient.ProductsAttributeSetsGroupsListAPI.GetV1ProductsAttributesetsGroupsList(context.Background()).SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field).SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value).SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType).SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field).SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction).SearchCriteriaPageSize(searchCriteriaPageSize).SearchCriteriaCurrentPage(searchCriteriaCurrentPage).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProductsAttributeSetsGroupsListAPI.GetV1ProductsAttributesetsGroupsList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetV1ProductsAttributesetsGroupsList`: EavDataAttributeGroupSearchResultsInterface
	fmt.Fprintf(os.Stdout, "Response from `ProductsAttributeSetsGroupsListAPI.GetV1ProductsAttributesetsGroupsList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetV1ProductsAttributesetsGroupsListRequest struct via the builder pattern
