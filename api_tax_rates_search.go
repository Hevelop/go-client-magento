...
type TaxRatesSearchAPI interface {

	/*
		GetV1TaxRatesSearch taxRates/search
		...
		@return ApiGetV1TaxRatesSearchRequest
	*/
	GetV1TaxRatesSearch(ctx context.Context) ApiGetV1TaxRatesSearchRequest

	// GetV1TaxRatesSearchExecute executes the request
	//  @return TaxDataTaxRateSearchResultsInterface
	GetV1TaxRatesSearchExecute(r ApiGetV1TaxRatesSearchRequest) (*TaxDataTaxRateSearchResultsInterface, *http.Response, error)
}

// TaxRatesSearchAPIService TaxRatesSearchAPI service
type TaxRatesSearchAPIService service

type ApiGetV1TaxRatesSearchRequest struct {
	ctx                                              context.Context
	ApiService                                       TaxRatesSearchAPI
...
// Field
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1TaxRatesSearchRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1TaxRatesSearchRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1TaxRatesSearchRequest) Execute() (*TaxDataTaxRateSearchResultsInterface, *http.Response, error) {
	return r.ApiService.GetV1TaxRatesSearchExecute(r)
}
...
Search TaxRates This call returns an array of objects, but detailed information about each object’s attributes might not be included. See https://developer.adobe.com/commerce/webapi/rest/attributes#TaxRateRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
	...
	@return ApiGetV1TaxRatesSearchRequest
*/
func (a *TaxRatesSearchAPIService) GetV1TaxRatesSearch(ctx context.Context) ApiGetV1TaxRatesSearchRequest {
	return ApiGetV1TaxRatesSearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return TaxDataTaxRateSearchResultsInterface
func (a *TaxRatesSearchAPIService) GetV1TaxRatesSearchExecute(r ApiGetV1TaxRatesSearchRequest) (*TaxDataTaxRateSearchResultsInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TaxDataTaxRateSearchResultsInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TaxRatesSearchAPIService.GetV1TaxRatesSearch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/V1/taxRates/search"
