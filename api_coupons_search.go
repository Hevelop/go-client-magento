...
type CouponsSearchAPI interface {

	/*
		GetV1CouponsSearch coupons/search
		...
		@return ApiGetV1CouponsSearchRequest
	*/
	GetV1CouponsSearch(ctx context.Context) ApiGetV1CouponsSearchRequest

	// GetV1CouponsSearchExecute executes the request
	//  @return SalesRuleDataCouponSearchResultInterface
	GetV1CouponsSearchExecute(r ApiGetV1CouponsSearchRequest) (*SalesRuleDataCouponSearchResultInterface, *http.Response, error)
}

// CouponsSearchAPIService CouponsSearchAPI service
type CouponsSearchAPIService service

type ApiGetV1CouponsSearchRequest struct {
	ctx                                              context.Context
	ApiService                                       CouponsSearchAPI
...
// Field
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1CouponsSearchRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1CouponsSearchRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1CouponsSearchRequest) Execute() (*SalesRuleDataCouponSearchResultInterface, *http.Response, error) {
	return r.ApiService.GetV1CouponsSearchExecute(r)
}
...
Retrieve a coupon using the specified search criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included. See https://developer.adobe.com/commerce/webapi/rest/attributes#CouponRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
	...
	@return ApiGetV1CouponsSearchRequest
*/
func (a *CouponsSearchAPIService) GetV1CouponsSearch(ctx context.Context) ApiGetV1CouponsSearchRequest {
	return ApiGetV1CouponsSearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SalesRuleDataCouponSearchResultInterface
func (a *CouponsSearchAPIService) GetV1CouponsSearchExecute(r ApiGetV1CouponsSearchRequest) (*SalesRuleDataCouponSearchResultInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SalesRuleDataCouponSearchResultInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CouponsSearchAPIService.GetV1CouponsSearch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/V1/coupons/search"
