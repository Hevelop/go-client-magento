...
type ShipmentsAPI interface {
	...
	/*
		...
		@return ApiGetV1ShipmentsRequest
	*/
	GetV1Shipments(ctx context.Context) ApiGetV1ShipmentsRequest

	// GetV1ShipmentsExecute executes the request
	//  @return SalesDataShipmentSearchResultInterface
	GetV1ShipmentsExecute(r ApiGetV1ShipmentsRequest) (*SalesDataShipmentSearchResultInterface, *http.Response, error)
}

// ShipmentsAPIService ShipmentsAPI service
type ShipmentsAPIService service

type ApiGetV1ShipmentsRequest struct {
	ctx                                              context.Context
...
// Field
func (r ApiGetV1ShipmentsRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1ShipmentsRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1ShipmentsRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1ShipmentsRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1ShipmentsRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1ShipmentsRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1ShipmentsRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1ShipmentsRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1ShipmentsRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1ShipmentsRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1ShipmentsRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1ShipmentsRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1ShipmentsRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1ShipmentsRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1ShipmentsRequest) Execute() (*SalesDataShipmentSearchResultInterface, *http.Response, error) {
	return r.ApiService.GetV1ShipmentsExecute(r)
}
...
Lists shipments that match specified search criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included. See https://developer.adobe.com/commerce/webapi/rest/attributes#ShipmentRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
	...
	@return ApiGetV1ShipmentsRequest
*/
func (a *ShipmentsAPIService) GetV1Shipments(ctx context.Context) ApiGetV1ShipmentsRequest {
	return ApiGetV1ShipmentsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SalesDataShipmentSearchResultInterface
func (a *ShipmentsAPIService) GetV1ShipmentsExecute(r ApiGetV1ShipmentsRequest) (*SalesDataShipmentSearchResultInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SalesDataShipmentSearchResultInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShipmentsAPIService.GetV1Shipments")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/V1/shipments"
