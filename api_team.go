...
type TeamAPI interface {
	...
	/*
		...
		@return ApiGetV1TeamRequest
	*/
	GetV1Team(ctx context.Context) ApiGetV1TeamRequest

	// GetV1TeamExecute executes the request
	//  @return CompanyDataTeamSearchResultsInterface
	GetV1TeamExecute(r ApiGetV1TeamRequest) (*CompanyDataTeamSearchResultsInterface, *http.Response, error)
}

// TeamAPIService TeamAPI service
type TeamAPIService service

type ApiGetV1TeamRequest struct {
	ctx                                              context.Context
	ApiService                                       TeamAPI
...
// Field
func (r ApiGetV1TeamRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1TeamRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1TeamRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1TeamRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1TeamRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1TeamRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1TeamRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1TeamRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1TeamRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1TeamRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1TeamRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1TeamRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1TeamRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1TeamRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1TeamRequest) Execute() (*CompanyDataTeamSearchResultsInterface, *http.Response, error) {
	return r.ApiService.GetV1TeamExecute(r)
}
...
Returns the list of teams for the specified search criteria (team name or description).
	...
	@return ApiGetV1TeamRequest
*/
func (a *TeamAPIService) GetV1Team(ctx context.Context) ApiGetV1TeamRequest {
	return ApiGetV1TeamRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return CompanyDataTeamSearchResultsInterface
func (a *TeamAPIService) GetV1TeamExecute(r ApiGetV1TeamRequest) (*CompanyDataTeamSearchResultsInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CompanyDataTeamSearchResultsInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamAPIService.GetV1Team")
	if err != nil {
