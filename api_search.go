...
type SearchAPI interface {
	...
	/*
		...
		@return ApiGetV1SearchRequest
	*/
	GetV1Search(ctx context.Context) ApiGetV1SearchRequest

	// GetV1SearchExecute executes the request
	//  @return FrameworkSearchSearchResultInterface
	GetV1SearchExecute(r ApiGetV1SearchRequest) (*FrameworkSearchSearchResultInterface, *http.Response, error)
}

// SearchAPIService SearchAPI service
type SearchAPIService service

type ApiGetV1SearchRequest struct {
	ctx                                              context.Context
...
func (r ApiGetV1SearchRequest) SearchCriteriaRequestName(searchCriteriaRequestName string) ApiGetV1SearchRequest {
	r.searchCriteriaRequestName = &searchCriteriaRequestName
	return r
}

// Field
func (r ApiGetV1SearchRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1SearchRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1SearchRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1SearchRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1SearchRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1SearchRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1SearchRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1SearchRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1SearchRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1SearchRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1SearchRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1SearchRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1SearchRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1SearchRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1SearchRequest) Execute() (*FrameworkSearchSearchResultInterface, *http.Response, error) {
	return r.ApiService.GetV1SearchExecute(r)
}
...
Make Full Text Search and return found Documents
	...
	@return ApiGetV1SearchRequest
*/
func (a *SearchAPIService) GetV1Search(ctx context.Context) ApiGetV1SearchRequest {
	return ApiGetV1SearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return FrameworkSearchSearchResultInterface
func (a *SearchAPIService) GetV1SearchExecute(r ApiGetV1SearchRequest) (*FrameworkSearchSearchResultInterface, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SearchAPIService.GetV1Search")
	if err != nil {
