...
type SalesRulesSearchAPI interface {

	/*
		GetV1SalesRulesSearch salesRules/search
		...
		@return ApiGetV1SalesRulesSearchRequest
	*/
	GetV1SalesRulesSearch(ctx context.Context) ApiGetV1SalesRulesSearchRequest

	// GetV1SalesRulesSearchExecute executes the request
	//  @return SalesRuleDataRuleSearchResultInterface
	GetV1SalesRulesSearchExecute(r ApiGetV1SalesRulesSearchRequest) (*SalesRuleDataRuleSearchResultInterface, *http.Response, error)
}

// SalesRulesSearchAPIService SalesRulesSearchAPI service
type SalesRulesSearchAPIService service

type ApiGetV1SalesRulesSearchRequest struct {
	ctx                                              context.Context
	ApiService                                       SalesRulesSearchAPI
...
// Field
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1SalesRulesSearchRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1SalesRulesSearchRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1SalesRulesSearchRequest) Execute() (*SalesRuleDataRuleSearchResultInterface, *http.Response, error) {
	return r.ApiService.GetV1SalesRulesSearchExecute(r)
}
...
Retrieve sales rules that match te specified criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included. See https://developer.adobe.com/commerce/webapi/rest/attributes#RuleRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
	...
	@return ApiGetV1SalesRulesSearchRequest
*/
func (a *SalesRulesSearchAPIService) GetV1SalesRulesSearch(ctx context.Context) ApiGetV1SalesRulesSearchRequest {
	return ApiGetV1SalesRulesSearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SalesRuleDataRuleSearchResultInterface
func (a *SalesRulesSearchAPIService) GetV1SalesRulesSearchExecute(r ApiGetV1SalesRulesSearchRequest) (*SalesRuleDataRuleSearchResultInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SalesRuleDataRuleSearchResultInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SalesRulesSearchAPIService.GetV1SalesRulesSearch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/V1/salesRules/search"
