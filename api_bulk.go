...
type BulkAPI interface {
	...
	*/
	GetV1Bulk(ctx context.Context) ApiGetV1BulkRequest

	// GetV1BulkExecute executes the request
	//  @return AsynchronousOperationsDataOperationSearchResultsInterface
	GetV1BulkExecute(r ApiGetV1BulkRequest) (*AsynchronousOperationsDataOperationSearchResultsInterface, *http.Response, error)
}
...
// Field
func (r ApiGetV1BulkRequest) SearchCriteriaFilterGroups0Filters0Field(searchCriteriaFilterGroups0Filters0Field string) ApiGetV1BulkRequest {
	r.searchCriteriaFilterGroups0Filters0Field = &searchCriteriaFilterGroups0Filters0Field
	return r
}

// Value
func (r ApiGetV1BulkRequest) SearchCriteriaFilterGroups0Filters0Value(searchCriteriaFilterGroups0Filters0Value string) ApiGetV1BulkRequest {
	r.searchCriteriaFilterGroups0Filters0Value = &searchCriteriaFilterGroups0Filters0Value
	return r
}

// Condition type
func (r ApiGetV1BulkRequest) SearchCriteriaFilterGroups0Filters0ConditionType(searchCriteriaFilterGroups0Filters0ConditionType string) ApiGetV1BulkRequest {
	r.searchCriteriaFilterGroups0Filters0ConditionType = &searchCriteriaFilterGroups0Filters0ConditionType
	return r
}

// Sorting field.
func (r ApiGetV1BulkRequest) SearchCriteriaSortOrders0Field(searchCriteriaSortOrders0Field string) ApiGetV1BulkRequest {
	r.searchCriteriaSortOrders0Field = &searchCriteriaSortOrders0Field
	return r
}

// Sorting direction.
func (r ApiGetV1BulkRequest) SearchCriteriaSortOrders0Direction(searchCriteriaSortOrders0Direction string) ApiGetV1BulkRequest {
	r.searchCriteriaSortOrders0Direction = &searchCriteriaSortOrders0Direction
	return r
}

// Page size.
func (r ApiGetV1BulkRequest) SearchCriteriaPageSize(searchCriteriaPageSize int32) ApiGetV1BulkRequest {
	r.searchCriteriaPageSize = &searchCriteriaPageSize
	return r
}

// Current page.
func (r ApiGetV1BulkRequest) SearchCriteriaCurrentPage(searchCriteriaCurrentPage int32) ApiGetV1BulkRequest {
	r.searchCriteriaCurrentPage = &searchCriteriaCurrentPage
	return r
}

func (r ApiGetV1BulkRequest) Execute() (*AsynchronousOperationsDataOperationSearchResultsInterface, *http.Response, error) {
...
Lists the bulk operation items that match specified search criteria.
	...
	@return ApiGetV1BulkRequest
*/
func (a *BulkAPIService) GetV1Bulk(ctx context.Context) ApiGetV1BulkRequest {
	return ApiGetV1BulkRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return AsynchronousOperationsDataOperationSearchResultsInterface
func (a *BulkAPIService) GetV1BulkExecute(r ApiGetV1BulkRequest) (*AsynchronousOperationsDataOperationSearchResultsInterface, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AsynchronousOperationsDataOperationSearchResultsInterface
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BulkAPIService.GetV1Bulk")
	if err != nil {
